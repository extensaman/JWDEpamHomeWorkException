...
public class FileWithHardcodeClientCreator {

    private FileWithHardcodeClientCreator() {
    }

    public static void start(FileWorker<Client> clientFileWorker) throws FileWorkerException {
        Client client01 = new Client("Bill", "Clinton", "+e19017658912", "billy@whitehouse.us");
